...
from booking.views import prod_list, product_details_view, order_list, history_list
from hotel.authentication import user_login, logout_view
from hotel.registration import register
